...
namespace Server.com.microsofttranslator.api {
    using System;
    ...
    public partial class SoapService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public SoapService() {
            this.Url = global::Server.Properties.Settings.Default.Server_com_microsofttranslator_api_SoapService;
        ...
        public void TranslateAsync(string appId, string text, string from, string to, string contentType, string category, string reservedFlags, object userState) {
            ...
            this.InvokeAsync("Translate", new object[] {
                        ...
                        contentType,
                        category,
                        reservedFlags}, this.TranslateOperationCompleted, userState);
        }
